...
let scraper = readFile(path.join(base, 'app/src/main/java/com/dondeloexan/data/remote/filmaffinity/FilmaffinityScraper.kt'));
...
writeFile(path.join(base, 'app/src/main/java/com/dondeloexan/data/remote/filmaffinity/FilmaffinityScraper.kt'), scraper);
...
// ===== 3. SearchItemCard.kt =====
let search = readFile(path.join(base, 'app/src/main/java/com/dondeloexan/presentation/discover/components/SearchItemCard.kt'));
...
writeFile(path.join(base, 'app/src/main/java/com/dondeloexan/presentation/discover/components/SearchItemCard.kt'), search);
